...
namespace Praktik_UI
{
    public partial class Suppliers1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                Suppliers1Grid.Rows.Add(StorageClass.Storage.PartList[i]._getid(), StorageClass.Storage.PartList[i]._getname(), StorageClass.Storage.PartList[i]._getamount(), StorageClass.Storage.PartList[i]._getprice());
            }
        }
